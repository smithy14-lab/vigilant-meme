    ...
    if (!string.IsNullOrEmpty(email))
    {
        ...
        if (user is not null)
        {
            ...
            await emailService.SendAsync(
                email,
                "Reset your CheerDeck Competitions password",
                $"""
                <h2>Password Reset</h2>
                <p>You requested a password reset for your CheerDeck Competitions account.</p>
                <p><a href="{resetUrl}" style="display:inline-block;padding:12px 24px;background:#dc3545;color:#fff;text-decoration:none;border-radius:6px;">Reset Password</a></p>
